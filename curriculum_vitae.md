...
**Machine Learning:** Deep Learning, Neural Networks, CNNs, Transformers, GANs, VAEs, GNNs, Flow Matching, Random Forests, SVM, Ensemble Methods, Model Compression, Quantization

**Programming:** Python, PyTorch, PyTorch Lightning, TensorFlow, Scikit-learn, C++, CUDA, FastAPI, SQL

**Data & Computation:** NumPy, Pandas, SciPy, Matplotlib, Distributed Training, GPU Optimization, High-Performance Computing
...
- Led research planning for large-scale initiatives, defining technical roadmaps and deliverables aligned with EU funding requirements, securing €1.3M in funding.
...
### [Audio VAE for Music Source Separation](https://github.com/mirxonius/audio_vae)
Developed variational autoencoder architecture for music source separation using the GTZAN dataset. Achieved high-quality audio reconstruction with a compressed (×512) latent space suitable for a variety of downstream tasks.

### [Flow Matching for Generative Modeling](https://github.com/mirxonius/flows)
Implemented flow matching algorithm from scratch in PyTorch for continuous normalizing flows, demonstrating state-of-the-art generative modeling techniques.
